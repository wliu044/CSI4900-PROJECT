...
export const DEL_PATCH_GOODS = 'del_patch_goods'; // 是否删除单个商品
export const DEL_ALL_GOODS = 'del_all_goods'; // 是否删除所有商品
export const SEARCH_KEYWORDS = 'search_goods'; // 关键词Search
export const INDENT_GOODS_LIST = 'indent_goods'; // 关键词Search
