...
const Indent = () => import("./../pages/Indent/Indent");
...
const WaitSend = () => import("./../pages/Me/Children/WaitSend");
const WaitReceive = () => import("./../pages/Me/Children/WaitReceive");
const Received = () => import("./../pages/Me/Children/Received");
  ...
  routes: [
    {
      path: "/home",
      component: Home,
      meta: { showHeaderTop: true, showHeaderSearch: true, showFooter: true }
    },
    {
      path: "/login",
      component: Login
    ...
    },
    {
      ...
      children: [
        ...
        { path: "waitsend", component: WaitSend },
        { path: "received", component: Received },
        { path: "waitreceive", component: WaitReceive },
    ...
    },
    {
      path: "/shopcar",
      component: ShopCar,
      meta: { showHeaderTop: true, showFooter: true }
    },
    {
      path: "/indent",
      component: Indent,
