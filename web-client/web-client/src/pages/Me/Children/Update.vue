  ...
  <div class="user-detail">
    ...
    <div class="user-detail-group">
      ...
      <div class="user-item">
        ...
        <span>{{ userInfo.user_phone || "Not set yet" }}</span>
      </div>
      <div class="user-item">
        <span>Account</span>
        <span>{{ userInfo.user_name || "Not set yet" }}</span>
      </div>
      <div class="user-item">
        <span>nickname</span>
        <el-input
      ...
      <div class="user-item">
        <span>Place of habitual residence</span>
        <el-input
          type="text"
          placeholder="Please enter the content"
      ...
      <el-button type="danger" @click="saveUserInfo()">edit</el-button>
    </div>
  </div>
</template>
  ...
  export default {
    ...
    methods:{
      beforeAvatarUpload(file) {
        ...
        if (!isJPG) {
          this.$message.error('Uploaded avatar images can only be in JPG or PNG format!');
        }
        if (!isLt2M) {
          this.$message.error('The size of the uploaded avatar image cannot exceed 1MB!');
        }
        return isJPG && isLt2M;
      },
