<template>
  <div class="pro_item">
    <h4 class="item_title"><span>Self operated store of vv mall</span><span class="item_one">{{goods.price / 100 | moneyFormat}}</span></h4>
  ...
  export default {
    ...
    methods:{
      ...
      updateGoodsCount(goods, count){
        ...
        if(count === 0){
          // 是否删除
          this.$confirm('Delete this item?', 'prompt', {
