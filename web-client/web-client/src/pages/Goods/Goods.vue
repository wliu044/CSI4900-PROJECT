  ...
  <div id="container" v-if="goodsDetail[0]">
      ...
      <div class="pro_meg">
        ...
        <div class="pro_meg_price">
          ...
          <dl>
            ...
            <dd>
              <span>Genuine quality assurance</span>
        ...
        <div class="pro_meg_console">
          <dl class="tb-sku">
            ...
            <dd>
              ...
              <span>stock</span><em>{{ goodsDetail[0].counts }}</em
              ><span>piece</span>
            </dd>
          </dl>
    ...
    <div class="pro_comment">
        ...
        >
          <div class="media-body">
            ...
            <h6 class="media-heading" v-else>
              User:&nbsp;{{ comment.user_name | nameFormat }}
            </h6>
      ...
      <div class="media" v-else>
        <div class="media-body">
          There are currently no comments on this product
        </div>
      </div>
    </div>
    <div class="pro_judge" v-if="userInfo.user_name">
      <h3>Evaluate this product</h3>
      ...
      <el-button type="primary" @click="post()"
        >publish<i class="el-icon-edit el-icon--right"></i
      ></el-button>
    </div>
    <div class="pro_judge" v-else>
      <h3>Evaluate this product</h3>
      <span class="judge_erro_tip">You cannot post comments until you log in</span>
      <el-button type="text" @click="$router.push('/login')">Go to login</el-button>
    </div>
  </div>
</template>
