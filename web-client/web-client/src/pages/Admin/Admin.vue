<template>
  <div id="admin">
    <nav class="navbar navbar-dark fixed-top bg-dark flex-md-nowrap p-0 shadow">
      ...
      <span class="nav_title">Welcome to the background management interface</span>
      <ul class="navbar-nav px-3">
        <li class="nav-item text-nowrap">
          <router-link class="nav-link" to="/home">Return to the mall</router-link>
        </li>
        <li class="nav-item text-nowrap">
          ...
          <div class="sidebar-sticky">
            ...
            <el-menu
              ...
              <el-menu-item index="2" @click="goTo('/admin/addgoods')">
                ...
                <span slot="title">Goods on the shelf</span>
              </el-menu-item>
